...
class Config:
  ...
  '''
  pass
  NEWS_SOURCSES_BASE_URL = 'https://newsapi.org/v2/sources?apiKey=402a190105ef46358f39216b088119f4'
  NEWS_BASE_URL ='https://newsapi.org/v2/everything?q=bitcoin&apiKey=402a190105ef46358f39216b088119f4 '
